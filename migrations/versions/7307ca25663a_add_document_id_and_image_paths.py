...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_pdf_questions_document_id', 'pdf_questions', 'faq_documents', ['document_id'], ['id'])
    ...
    op.add_column('pdf_answers', sa.Column('answer_vector', Vector(384), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_constraint('fk_pdf_questions_document_id', 'pdf_questions', type_='foreignkey')
