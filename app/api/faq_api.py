...
# ✅ Server path — IIS server pe PDFs yahan save hongi
BACKUP_DIR_PDFS      = r"C:\inetpub\wwwroot\ChatBot\pdfs"
BACKUP_DIR_FAQ       = r"C:\inetpub\wwwroot\ChatBot\faq"

# Server ka public URL — file access ke liye
